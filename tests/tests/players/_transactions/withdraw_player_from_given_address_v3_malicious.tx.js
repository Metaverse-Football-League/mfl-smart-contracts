export const WITHDRAW_PLAYER_FROM_GIVEN_ADDRESS_V3 = `import NonFungibleToken from "../../../contracts/_libs/NonFungibleToken.cdc"
...
transaction(senderAddr: Address, receiverAddr: Address, id: UInt64) {
    ...
    prepare(acct: auth(BorrowValue) &Account) {
        ...
        self.senderRef = getAccount(senderAddr).storage.borrow<auth(NonFungibleToken.Withdraw) &MFLPlayer.Collection>(
