export const OPEN_PACK_MALICIOUS_V2 = `import NonFungibleToken from "../../../contracts/_libs/NonFungibleToken.cdc"
 ...
 **/
 ...
 transaction(walletAddr: Address, revealID: UInt64) {
    ...
    prepare(owner: auth(BorrowValue, SaveValue, IssueStorageCapabilityController, PublishCapability, UnpublishCapability) &Account) {
        self.collectionRef = getAccount(walletAddr).capabilities.borrow<&MFLPack.Collection>(MFLPack.CollectionPublicPath) ?? panic("Could not borrow the collection reference")
    }
