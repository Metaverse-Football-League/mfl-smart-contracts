export const WITHDRAW_CLUB_FROM_GIVEN_ADDRESS_V3 = `import NonFungibleToken from "../../../contracts/_libs/NonFungibleToken.cdc"
...
transaction(senderAddr: Address, receiverAddr: Address, id: UInt64) {
    ...
    prepare(acct: auth(BorrowValue) &Account) {
        ...
        self.senderRef = getAccount(senderAddr).storage.borrow<auth(NonFungibleToken.Withdraw) &MFLClub.Collection>(
           from: MFLClub.CollectionStoragePath
