export const BATCH_WITHDRAW_CLUB_FROM_GIVEN_ADDRESS_V2 = `import NonFungibleToken from "../../../contracts/_libs/NonFungibleToken.cdc"
...
transaction(senderAddr: Address, receiverAddr: Address, ids: [UInt64]) {
    ...
    prepare(acct: auth(BorrowValue) &Account) {
        ...
        self.senderRef = getAccount(senderAddr).capabilities.borrow<&MFLClub.Collection>(
