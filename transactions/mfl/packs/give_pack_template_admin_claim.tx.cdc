...
transaction(receiverAddress: Address, privatePath: Path) {
    ...
    let packTemplateAdminClaimCapability: Capability<&MFLPackTemplate.PackTemplateAdmin{MFLPackTemplate.PackTemplateAdminClaim}>
    ...
    prepare(acct: AuthAccount) {
        ...
        self.packTemplateAdminClaimCapability = acct.link<&MFLPackTemplate.PackTemplateAdmin{MFLPackTemplate.PackTemplateAdminClaim}>(privateCapabilityPath!, target: MFLPackTemplate.PackTemplateAdminStoragePath) ?? panic("path already exists")
    }
