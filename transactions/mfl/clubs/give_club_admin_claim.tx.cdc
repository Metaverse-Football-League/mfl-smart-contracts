...
transaction(receiverAddress: Address, privatePath: Path) {
    ...
    let clubAdminClaimCapability: Capability<&MFLClub.ClubAdmin{MFLClub.ClubAdminClaim}>
    ...
    prepare(acct: AuthAccount) {
        ...
        self.clubAdminClaimCapability = acct.link<&MFLClub.ClubAdmin{MFLClub.ClubAdminClaim}>(privateCapabilityPath!, target: MFLClub.ClubAdminStoragePath) ?? panic("path already exists")
    }
